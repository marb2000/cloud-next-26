...
async function registerTrigger(triggerId, payload) {
  ...
  const url = `https://firebasevertexai.googleapis.com/v1beta/projects/${PROJECT_ID}/locations/global/triggers/${triggerId}?updateMask=cloudFunction&allowMissing=true`;
  console.log(`📤 Registering trigger via PATCH: ${url}`);
