...
async function registerTrigger(triggerId, payload) {
  ...
  // Try firebaseml.googleapis.com instead of firebasevertexai.googleapis.com
  const url = `https://firebaseml.googleapis.com/v1beta/projects/${PROJECT_ID}/locations/global/triggers?triggerId=${triggerId}&validateOnly=false`;
